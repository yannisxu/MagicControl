...
use tauri::menu::{MenuBuilder, MenuItemBuilder, MenuItem, MenuId};
        ...
        .on_menu_event(move |app, event| {
            ...
            match id {
                ...
                "feedback_toast" => {
                    ...
                    log_line(&format!("Toggle Toast: current (post-click)={}", is_checked));
...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            app.manage(Mutex::new(TrayState { status_item: Some(status_item) }));
            
            log_line("Magic Control v2 started");
            Ok(())
        })
        .invoke_handler(tauri::generate_handler![set_click_through, press_key, update_tray_status])
